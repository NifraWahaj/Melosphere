...
<title>All Uploaded Songs</title>
	<style>
	audio {
...
%>
    ...
    <span class="fs-4 mt-4 myText-dark">Melosphere</span>
        ...
        <main class="container-md py-4" style="padding-left: 10em;">
			<h2 class="fs-1 fw-bold">All Songs</h2>
            <hr>
  ...
  %>
      	...
      	<div class="p-3 row text-whi te-50 shadow myBg-gray rounded my-3" >
				  ...
				  <div class="col-4"><%= song.getGenre() %></div>
    				...
    				<li><form action="./ArtistDeleteSong.jsp" class="dropdown-item L-Affiliate-Tagged">
                            <input type="hidden" name="SName" id="SName" value="<%= song.getSName() %>">
                            <button type="submit" class="myBtn-red px-5" >Delete </button>
                             </form>
                            </li>
