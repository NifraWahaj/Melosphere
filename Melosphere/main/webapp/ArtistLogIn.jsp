	...
	<body>
		<div class="customLinearGradient">
			<main class="loginMain d-flex justify-content-center align-items-lg-center">
					<form class="form-signin text-center" action = "ArtistLogInServlet">
					  ...
					  <input type="text" id="inputUsername" class="form-control mb-3" placeholder="Username" name = "AName" required autofocus>
					
					  <label for="inputEmail" class="sr-only">Email address</label>
					  <input type="email" id="inputEmail" class="form-control mb-3" placeholder="Email address" name = "AEmail" required autofocus>
					 
			
					 
					  <label for="inputPassword" class="sr-only">Password</label>
					  <input type="password" id="inputPassword" class="form-control mb-3" placeholder="Password" name = "APassword" required> 
					  <button class="myBtn-lg" type="submit">Log In</button>
					  <div class="checkColor mt-3">
						  <p>Not a member? <a href="ArtistSignUp.jsp" class="myText-love text-decoration-none customHover">Sign Up</a></p>
					  </div>
					</form>
			</main>
