...
<% } %>
    ...
    <span class="fs-4 mt-4 myText-dark">Melosphere</span>
     ...
     <form class="nav-item mb-3" action="./search" method="get">
					...
					<li class="nav-item mb-3">
						<a href="./ListenerGetPlaylistDummy" class="d-flex align-items-center text-white text-decoration-none L-Affiliate-Tagged L-Affiliate-Tagged" aria-current="page">
		...
		<main class="container-md py-4" style="padding-left: 15em;">
				 <h2 class="fs-1 fw-bold">WELCOME ${LName}</h2>
			<h2 class="fs-1 fw-bold">Discover</h2>
			<section class="artists">
				<hr>
				<div class="artists row mt-5">
					
					
				<h3 class="fs-3 mb-3">Recommended Artists</h3>
  <%
  List<Artist> artistList = (ArrayList<Artist>)request.getAttribute("artists");
						...
						<div class="card myBg-Light" style="width: 15rem;">
							<div class="card-body">
								...
								<form action="ListenerArtistViewDummy.jsp" method="post">
								  <input type="hidden" name="AName" id="AName" value="<%= artist.getName() %>">
    ...
    %>
			...
			<section class="mostPlayed mt-5">
				<h3 class="fs-3 mb-3">Recommended Songs</h3>
				<hr>
