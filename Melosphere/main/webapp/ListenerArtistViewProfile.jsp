...
<nav class="d-flex flex-column justify-content-between flex-shrink-0 p-3 vh-100 myBg-Light position-fixed"
    ...
    <span class="fs-4 mt-4 myText-dark">Melosphere</span>
     ...
     <form class="nav-item mb-3" action="./search" method="get">
        ...
        String ABio = (String) request.getAttribute("ABio");%>
            <h2 class="fs-1 fw-bold">${AName}</h2> <!-- getName -->
           
            <section class="artists">
                <hr>
                <h3 class="fs-3 mb-3 mt-4">Bio</h3>
                <p>${ABio}</p>
                ...
                if(isFollowing)
                {%>
                <form action="./UnFollowArtist.jsp">
                <input type="hidden" name="AName" id="AName" value="<%=AName%>">
           
                
                <button type="submit" class="myBtn px-5">UnFollow</button></form>
                <%}else{%>
                <form action="./FollowArtist.jsp">
                <input type="hidden" name="AName" id="AName" value="<%=AName%>">
                <button type="submit" class="myBtn px-5">Follow</button></form>
                <%}%>                
            </section>
           
          
            <section class="mostPlayed mt-5">
				<h3 class="fs-3 mb-3">Top Songs</h3>
				<hr>
				<div class="row">
    ...
    <hr>
	 ...
	 List<Song> TopStremed = (ArrayList<Song>)request.getAttribute("TopStreamed");
    if(TopStremed != null && TopStremed.size() > 0) {
        for(Song song : TopStremed) {
  %>
  ...
  %>
			...
			FUNC CALLED HERE 
			 ...
			 <br><br>
   			 <section class="mostPlayed mt-5">
				<h3 class="fs-3 mb-3">All Songs</h3>
				<hr>
				<div class="row">
		 	<div class="col-2"> Song    </div>	
		<div class="col-2"> Artist  </div>
