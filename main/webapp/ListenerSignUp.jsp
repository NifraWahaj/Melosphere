	...
	<body>
		<div class="customLinearGradient">
			<main class="loginMain d-flex justify-content-center align-items-lg-center">
					<form class="form-signin text-center" action = "ListenerSignUpServlet" method = "POST">
					  ...
					  <input type="email" class="form-control mb-3" placeholder="Email address" name="LEmail" required autofocus>
					   <label for="inputFName" class="sr-only">Username</label>
					  <input type="text" class="form-control mb-3" placeholder="Username" name="LName" required autofocus>
					  <label for="inputPassword" class="sr-only">Password</label>
					  <input type="password" class="form-control mb-3" placeholder="Password" name="LPassword" required> 
					  <button class="myBtn-lg" type="submit">Sign Up</button>
					  <div class="checkColor mt-3">
						  <p>Already a member? <a href="ListenerLogIn.jsp" class="myText-love text-decoration-none customHover">Login</a></p>
					  </div>
					</form>
			</main>
