...
<nav class="d-flex flex-column justify-content-between flex-shrink-0 p-3 vh-100 myBg-Light position-fixed"
  ...
  %>
            ...
            <section class="artists">
                ...
                <p>Email:            <%=  Email %></p>
                <p>Password:         *****</p>
                <a href="./ArtistEditProfile.jsp"><button class="myBtn px-5">Edit</button></a>
                <a href="./ArtistDeleteProfileDummy.jsp"><button class="myBtn-red px-5">Delete Profile</button></a>
            </section>
        </main>
  </div>
